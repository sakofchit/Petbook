...
class PetbookVideoPlayer extends StatefulWidget {
  const PetbookVideoPlayer({
    @required this.path,
  ...
  @override
  State<StatefulWidget> createState() => _PetbookVideoPlayerState();
}

class _PetbookVideoPlayerState extends State<PetbookVideoPlayer> {
